...
function check(){
	...
	var filename3 = document.getElementById("filename4").value;
// 	如果不是三个文件夹同时上传则报错
  ...
  <body>
 <h1 align="center" class="text-info" style="font-family:宋体;font-weight:bold;font-size:49px"> 上传有机酸报告相关文件</h1>
...
<!-- style="border-collapse:separate; border-spacing:0px 10px; -->
 ...
 <tr>
  <td colspan="2"><font color ="red">*</font><b class="text-muted">请上传带config属性表格，并命名为rangeNew.xlsx</b></td>
 </tr>
 <tr>
 ...
 <td class="text-muted" align="center">上传文件为：</td><td><input type="file" name="filename" id="filename2"  class="form-control"></td>
  ...
  <tr>
  <td colspan="2"><font color ="red">*</font><b class="text-muted">请上传带exp属性表格,并命名为testR.xlsx</b></td>
 </tr>
 <tr>
 ...
 <tr>
  <td colspan="2"><font color ="red">*</font><b class="text-muted">请上传zip压缩包，并将其命名为image.zip</b></td>
 </tr>
 <tr>
 <td class="text-muted" align="center">选择上传的图包：</td><td><input type="file" name="filename" id="filename4"  class="form-control"></td>
 </tr>
