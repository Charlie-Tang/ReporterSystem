...
if(window.top!=window){
	 window.top.location = "administrator";
}
</script>
</head>
<body>
<body style="background:000000">
  <center>
     <h1 class="text-info" style="font-family:宋体;font-weight:bold;font-size:49px">管理员登录</h1>
     <br/>
     <form action="${pageContext.request.contextPath}/AdministratorServlet" method="post" onsubmit="return check()">
